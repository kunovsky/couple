...
module GeneralHappiness
  ...
  general_happiness.questions.create! content: "I feel that my partner is interested in me"
  ...
  general_happiness.questions.create! content: "I have respect and admiration for my partner"
  general_happiness.questions.create! content: "My partner pays attention to me"
  ...
  good = general_happiness.results.create!(quadrant_type: "individual_good", overall: "good", content: "Congratulations, in general you are happy with your relationship!", recommendation: "Your relationship is a sense of strength to you but you already knew that. In order to keep things on track we recommend checking out our 5 & 1/2 hour a week app.") # You scored good - you have no problems in this area
  good.products << general_happiness_products[0]
  ...
  good = general_happiness.results.create!(quadrant_type: "couple_good_good", overall: "good", content: "Congratulations, in general both you and your partner are happy with your relationship!", recommendation: "Your relationship is a sense of strength to both of you but you already knew that. In order to keep things on track we recommend checking out our 5 & 1/2 hour a week app") # You both scored good - this relationship no problems
  good.products << general_happiness_products[0]
